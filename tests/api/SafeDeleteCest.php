...
use app\fixtures\SafeDeleteFixture;
use app\fixtures\SafeDeleteChildFixture;

/**
 * Cest to safe-delete resource.
 *
 * @author Carlos (neverabe) Llamosas <carlos@tecnocen.com>
 */
class SafeDeleteCest extends \tecnocen\roa\test\AbstractResourceCest
{
    ...
    public function fixtures(ApiTester $I)
    {
        $I->haveFixtures([
            ...
            'safe_delete' => SafeDeleteFixture::class,
            'safe_delete_child' => SafeDeleteChildFixture::class,
        ]);
    }
    /**
     * @param  ApiTester $I
    ...
    {
        $I->wantTo('Retrieve list of SafeDelete records.');
    ...
    {
        $I->wantTo('Delete a SafeDelete record.');
